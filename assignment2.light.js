...
class DirectionalLight extends Light {
    ...
    update( ) {
        ...
        mat4.getRotation(lightDirection, this.model_matrix);
        this.target_shader.use();
...
class PointLight extends Light {
    ...
    update( ) {
        ...
        mat4.getTranslation(lightPosition, this.model_matrix);
        this.target_shader.use();
        this.target_shader.setUniform3f(`u_lights_point[${this.id}].position`, lightPosition);
