...
class Object3D
{
     ...
     */
    constructor( gl, shader, vertices, indices, draw_mode, objectType )
    {
        this.shader = shader
    ...
    createVAO( gl, shader )
    {
       ...
       // Configure the position attribute in the shader
       if(this.objectType === "box"){
        const positionAttribute = shader.getAttributeLocation('a_position');
...
class ShadedObject3D extends Object3D { 
    ...
    render( gl )
    {
       // throw '"ShadedObject3D.render" not implemented'
        ...
        super.render( gl )
        // Clean up material after rendering
        this.shader.unuse();
    }
}
